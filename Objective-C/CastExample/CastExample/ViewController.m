...
- (void)viewDidLoad {
  ...
  self.kAdTagUrl =
      ...
      @"single_ad_samples&ciu_szs=300x250&impl=s&gdfp_req=1&env=vp&"
      @"output=vast&unviewed_position_start=1&cust_params=deployment%3Ddevsite%"
      @"26sample_ct%3Dlinear&"
      @"correlator=";
  self.adIsVmap = false;
  ...
  self.castViewController =
      [[CastViewController alloc] initWithViewController:self];
...
- (void)showChooseDevice {
  [self.navigationController pushViewController:self.castViewController
                                       animated:YES];
}
...
- (void)requestAds {
  ...
  IMAAdsRequest *request =
      [[IMAAdsRequest alloc] initWithAdTagUrl:self.kAdTagUrl
...
adsLoadedWithData:(IMAAdsLoadedData *)adsLoadedData {
  ...
  IMAAdsRenderingSettings *adsRenderingSettings =
      [[IMAAdsRenderingSettings alloc] init];
